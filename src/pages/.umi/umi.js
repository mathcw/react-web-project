...
import findRoute, {
  getUrlQuery,
} from '/Users/wangcheng/www/b2b-front-beta-ts/node_modules/_umi-build-dev@1.16.8@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/_umi-plugin-ui@1.4.8@umi-plugin-ui/lib/bubble').default(
      {
        port: 3002,
        path: '/Users/wangcheng/www/b2b-front-beta-ts',
        currentProject: '',
        isBigfish: undefined,
      },
    );
