...
const Page: React.FC<IActionPageProps> = ({ route, location }) => {
    ...
    const lookChange = () => {
        Modal.info({
            ...
            content: (
                <>
                    <Col className={styles.tourist}>
                        <Col span={24} className={styles.ListTitle}>历史名单：</Col>
                        <Col span={24} className={styles.tableBorder}>
                            <Col span={4} className={styles.tableTitle}>
                                <span className={styles.key}>姓名 </span>
                            </Col>
                    ...
                    <Col className={styles.tourist} style={{marginTop:'10px'}}>
                        <Col span={24} className={styles.ListTitle}>变更名单：</Col>
                        <Col span={24} className={styles.tableBorder}>
                            <Col span={4} className={styles.tableTitle}>
                                <span className={styles.key}>姓名 </span>
                            </Col>
    ...
    const ajustFee = (ajustFeeData: any[]) => {
        if (ajustFeeData && ajustFeeData.length > 0) {
            return (
                <Col>
                    <Col span={20} className={styles.adjustment}>调整费用</Col>

                    <br />
                    <Col className={styles.listtable} style={{ border: "1px solid #d9d9d9", padding: "5px", borderRadius: "5px", marginTop: "5px" }}>
                        ...
                        {ajustFeeData.map((base: any, key: number) => (
                            <Col key={key} className={[styles.cCell, 'clear'].join(' ')}>
        ...
        return (
            <Col className={[styles.childrenMod, 'clear'].join(' ')}>
                ...
                <Col className={styles.ModContent}>
                    ...
                    <Col className={open ? styles.content : 'hide'}>
                        <Col className={styles.changeDetail}>
                            <Col span={11} className={styles.changeleft}>
                                <Col className={styles.title} span={24}>原始明细</Col>
                                <Col className={styles.content}>
                                    <Col span={24} className={styles.people}>
                                        <span>报名人数: {detail.num_of_people}</span>
                                    </Col>
                                    <Col span={24} className={styles.teamtake}>基础团费</Col>
                                    <Col className={styles.listtable}>
                            ...
                            <Col span={12} className={styles.changeright}>
                                <Col className={styles.title}>变更详情</Col>
