        ...
        Modal.info({
            ...
            content: (
                ...
                <div className={styles.tableDiv}>
                  {detail['订单名单'] && detail['订单名单'].map((val:any,key:number) => (
                    <Col span={24} className={styles.tableBorder} key={key}>
            ...
            <Col className={[styles.childrenMod, 'clear'].join(' ')}>
                ...
                <Col className={styles.ModContent}>
                    <Col className={[styles.ModCell, 'clear'].join(' ')}>
                        ...
                        <span className={styles.detail} onClick={()=>setShow(!isShow)}> {isShow ? '详情' : '收起'}</span>
                    </Col>
                    <Col className={styles.childrenother} style={isShow?{display:'block'}:{display:'none'}}>
                        ...
                        {
                            detail['订单应转'] && detail['订单应转'].map((snap:any) => (
                                <Col className={[styles.cCell, 'clear'].join(' ')}>
            ...
            <Col className={[styles.childrenMod, 'clear'].join(' ')}>
                ...
                <Col className={styles.ModContent}>
                    <Col className={styles.childrenother}>
                        ...
                        {
                            detail['订单备注'] && detail['订单备注'].map((val:any) => (
                                <Col className={[styles.cCell, 'clear'].join(' ')}>
            ...
            <Col className={[styles.childrenMod, 'clear'].join(' ')}>
                ...
                <Col className={styles.ModContent}>
                    <Col className={styles.childrenother}>
                        ...
                        {
                            detail['订单审批日志'] && detail['订单审批日志'].map((item:any) => (
                                <Col className={[styles.cCell, 'clear'].join(' ')}>
